...
if (dateToday.getMonth() < 3) {
    currentQuarter = `1 квартал ${dateToday.getFullYear()}`;
    prevQuarter = `4 квартал ${dateToday.getFullYear() - 1}`;
}
else if (dateToday.getMonth() >= 3 && dateToday.getMonth() < 6) {
    currentQuarter = `2 квартал ${dateToday.getFullYear()}`;
    prevQuarter = `1 квартал ${dateToday.getFullYear()}`;
}
else if (dateToday.getMonth() >= 6 && dateToday.getMonth() < 9) {
    currentQuarter = `3 квартал ${dateToday.getFullYear()}`;
    prevQuarter = `2 квартал ${dateToday.getFullYear()}`;
}
else {
    currentQuarter = `4 квартал ${dateToday.getFullYear()}`;
    prevQuarter = `3 квартал ${dateToday.getFullYear()}`;
}
